...
<title>Web Restaurants - Restaurants</title>
...
<div id="wrapper">
  <div id="headerDiv">
	...
	<div id="adminContentDiv">
      <h2>Restaurants</h2>
      <br/> <p><a href="home-guest.jsp">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Restaurants&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="home-guest-friends.jsp">Friends</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="home-guest-profile.jsp">My Profile</a></p>
      <br/>
      ...
      <c:forEach items="${restorani}" var="restoran">
      		<div>
      		    ...
      		    <tr>
      		      <td valign="top" bgcolor="#FFFFFF">Address:<b><i>${restoran.adresa}</i></b></td>
      		      <td rowspan="2" valign="top">Description:<b><i>${restoran.opis}</i></b></td>
	          </tr>
      		    <tr>
      		      <td valign="bottom" bgcolor="#FFFFFF"><form name="form1" method="post" action="./OpenRestaurantServlet">
					<input type="text" value="${restoran.id}" name="id" style="display:none">      		       
                    <input type="submit" name="openRestaurant" id="openRestaurant" value="Open Restaurant">
   		          </form></td>
   		      </tr>
      		</div>
      </c:forEach>
